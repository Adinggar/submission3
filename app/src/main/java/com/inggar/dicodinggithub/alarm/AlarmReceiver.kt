package com.inggar.dicodinggithub.alarm
...
import com.inggar.dicodinggithub.MainActivity
...
class AlarmReceiver : BroadcastReceiver() {
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(context, "Daily Reminder Inactive", Toast.LENGTH_SHORT).show()
    }
